    ...
    .then(data => {
      ...
      data.map(mission => {
        let htmlData = `<div class="card">
                                <div class="image">
                                    <img src="${mission.links.mission_patch_small? mission.links.mission_patch_small : 'https://blog.rahulbhutani.com/wp-content/uploads/2020/05/Screenshot-2018-12-16-at-21.06.29.png'}" alt="">
                                </div>
                                <div class="data">
